...
import org.matsim.evacuationgui.utils.NetworksComparator;
...
public class ScenarioGeneratorIT {
    ...
    public void testScenarioGenerator() {
        ...
        String inputDir = "test/input/" + ScenarioGeneratorIT.class.getCanonicalName().replace('.', '/') + "/testScenarioGenerator/";
...
//		System.exit(0);
        ...
        try {
            ScenarioGenerator scengen = new org.matsim.evacuationgui.scenariogenerator.ScenarioGenerator(gripsFileString);
            scengen.run();
        } catch (Exception e) {
